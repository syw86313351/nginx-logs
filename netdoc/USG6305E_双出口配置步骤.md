...
| 接口 | 描述 | 安全域 | IP 地址 | 备注 |
|------|------|--------|---------|------|
| GE0/0/0 | 公网带宽入口 | untrust | 运营商分配 | WAN2 备出口 |
| GE0/0/1 | 内网交换机1 | trust | 192.168.254.1/24 | LAN 内网网关 |
| GE0/0/2 | 管理口-接交换机1 | trust | — | 内网管理 |
| GE0/0/3 | 内网交换机2 | trust | — | LAN 扩展 |
| XGE0/0/0 | 公网出口 | untrust | 182.140.240.121 | WAN1 主出口（已有） |
| MEth0/0/0 | 带外管理口 | trust | 192.168.10.210 | 设备管理专用，不承载业务 |
